 ...
 * @method static SearchFacesByImageResultData searchFacesByImage(SearchFacesByImageData $searchFacesByImageData) Searches for faces using a supplied image. It first detects the largest face in the image, and then searches a specified collection for matching faces.
 *
